trigger ActivityTrackerTrigger_NWL on ActivityTracker__c (after delete, after insert, after update,
...
// BEFORE_INS_TRIGGER_CAT
        .addExecutor(
            ...
            new ActivityTrackerExecutor_NWL( Trigger.new, Base_NWL.BEFORE_INS_TRIGGER_CAT )
        )
